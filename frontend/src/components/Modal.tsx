...
export default function Modal() {
  ...
  return (
    ...
    >
      ...
      {/* Modal content */}
      <div
        className={`relative bg-white/95 backdrop-blur-[4px] rounded-2xl shadow-2xl border border-white/20 w-full ${getModalSize()} transform transition-all duration-300 ${
          isOpen
        ...
        style={{
          boxShadow:
            "0 25px 50px rgba(103, 105, 124, 0.25), 0 0 0 1px rgba(255, 255, 255, 0.1)",
        }}
      ...
      >
        ...
        ></div>
        <div
          className="absolute bottom-0 left-0 w-16 h-16 rounded-full blur-2xl opacity-8"
        ...
        <div className="relative z-10 p-8">
          ...
          {/* Custom content */}
          {config.content && <div className="mb-6">{config.content}</div>}
