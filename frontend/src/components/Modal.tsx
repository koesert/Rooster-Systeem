...
export default function Modal() {
    ...
    return (
        <div
            ...
            style={{ background: 'rgba(18, 3, 9, 0.8)' }}
        ...
        >
            ...
            {/* Modal content */}
            <div
                className={`relative bg-white/95 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 w-full ${getModalSize()} transform transition-all duration-300 ${isOpen ? 'scale-100 opacity-100 translate-y-0' : 'scale-95 opacity-0 translate-y-4'
                    }`}
                style={{
