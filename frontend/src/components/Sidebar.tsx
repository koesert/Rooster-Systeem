...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <div
        className="mobile-header fixed top-0 left-0 right-0 z-40 h-16 px-4 flex items-center justify-between text-white"
        style={{ background: "linear-gradient(90deg, #120309, #090c02)" }}
      >
      ...
      >
        ...
        ></div>
        <div
          className="absolute bottom-1/3 left-0 w-24 h-24 rounded-full blur-2xl opacity-8"
              ...
              <li key={index}>
                <button
                  ...
                  style={{
                    ...
                    background: isActive(item.path)
                      ? "linear-gradient(135deg, #d5896f40, #d5896f30)"
                      : "transparent",
                  }}
                  onMouseEnter={(e) => {
                    if (!isActive(item.path)) {
                      ...
                      target.style.background =
                        "linear-gradient(135deg, #d5896f30, #d5896f20)";
                ...
                >
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, #d5896f40, #d5896f20)",
                    }}
                  >
          ...
          <div className="relative z-10 flex-shrink-0 pt-4 border-t border-gray-700/30">
            <button
              ...
              onMouseEnter={(e) => {
                const target = e.target as HTMLElement;
                target.style.background =
                  "linear-gradient(135deg,rgb(224, 61, 61),rgb(226, 119, 119))";
                target.style.color = "#ffffff";
                target.style.transform = "translateX(4px)";
              }}
              onMouseLeave={(e) => {
