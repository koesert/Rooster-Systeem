...
export default function CreateShiftPage() {
  ...
  return (
    ...
    >
      {/* Hidden Sidebar - only visible on hover */}
      <div
      ...
      <div
        className={`fixed left-0 top-0 h-full w-64 text-white p-4 flex flex-col z-50 transition-transform duration-300 ${
          isHoveringSidebar ? "translate-x-0" : "-translate-x-full"
        }`}
      ...
      >
        ...
        <div className="mb-8 relative z-10 flex-shrink-0">
          <div className="flex items-center space-x-3 mb-4">
            <div
              ...
              style={{
                background: "linear-gradient(135deg, #d5896f20, #d5896f10)",
                border: "1px solid rgba(213, 137, 111, 0.2)",
              }}
          ...
          {user && (
            <div className="px-4">
              <p className="text-sm" style={{ color: "#e8eef2" }}>
                Ingelogd als:{" "}
                <span className="font-semibold" style={{ color: "#d5896f" }}>
                  {user.firstName}
                </span>
              </p>
            </div>
        ...
        <nav className="flex-1 relative z-10">
          <ul className="space-y-3">
            {[
              ...
              { name: "Profiel", icon: User, path: "/profile" },
              { name: "Rooster", icon: CalendarDays, path: "/schedule" },
              {
                name: "Beschikbaarheid",
                icon: CalendarCheck,
                path: "/availability",
              },
              { name: "Nieuwe shift", icon: Plus, path: "/schedule/create" },
            ].map((item, index) => (
              <li key={index}>
                <button
                  onClick={() => navigateToPage(item.path)}
                  className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-300 group cursor-pointer hover:shadow-lg ${
                    item.path === "/schedule/create" ? "shadow-lg" : ""
                  }`}
                  style={{
                    color:
                      item.path === "/schedule/create" ? "#ffffff" : "#e8eef2",
                    background:
                      item.path === "/schedule/create"
        ...
        <div className="pt-4 border-t border-white/10">
          <button
            ...
            className="w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-300 hover:shadow-lg cursor-pointer"
            style={{
              color: "#e8eef2",
          ...
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg,rgba(173, 33, 33, 0.25), #dc262620)",
              }}
            >
