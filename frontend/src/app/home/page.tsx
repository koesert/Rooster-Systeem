...
export default function HomePage() {
  ...
  const { user, isLoading, justLoggedIn, clearJustLoggedIn, isManager } =
    useAuth();
  ...
  return (
    ...
    >
      ...
      {showWelcomeNotification && (
        ...
        >
          <div
            className="bg-white/95 backdrop-blur-lg rounded-xl shadow-2xl border border-white/20 p-4 transform transition-all duration-500 ease-out animate-slide-in"
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm mt-1" style={{ color: "#67697c" }}>
                  Welkom terug, {user.fullName}. Je dashboard is klaar voor
                  gebruik.
                </p>
              </div>
              <button
            ...
            <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-white/20 p-8 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h1
                      className="text-4xl font-bold lg:text-4xl text-2xl"
                      style={{
                    ...
                    {getAllShiftsForDate(currentDate).length === 0 ? (
                      <div className="text-center py-16">
                        ...
                        <p className="mt-2 text-gray-600">
                          Je hebt geen geplande shifts voor vandaag.
                        </p>
                      </div>
                    ) : (
                      <div
                      ...
                      >
                        ...
                        {timeSlots.map((time, timeIndex) => (
                          <React.Fragment key={`time-row-${timeIndex}`}>
                            {/* Time label */}
                            <div
                              className="bg-white p-2 flex items-start"
                ...
                {isLoadingAvailability ? (
                  <div className="text-center py-8">
                    <div
                      ...
                      style={{ borderColor: "#d5896f" }}
                    ></div>
                    <p className="mt-2 text-sm" style={{ color: "#67697c" }}>
                      Laden...
                    </p>
                  </div>
                ) : (
